...
import {
    faAdjust, faAngleDoubleLeft, faAngleDoubleRight, faArrowDown, faArrowLeft,
    faArrowUp, faBan, faBars, faBook, faBullhorn, faChartBar, faCheck,
    faCheckSquare, faChevronDown, faCircleHalfStroke, faClock, faCloud,
    faCloudUpload, faCloudUploadAlt, faCode, faCodeBranch, faCog, faCogs,
    faComments, faCompressAlt, faCopy, faDatabase, faDownload, faEdit,
    faEllipsisH, faEllipsisV, faExclamation, faExclamationCircle,
    faExclamationTriangle, faExternalLinkAlt, faEye, faFile, faFileAlt,
    faFileExport, faFileSignature, faFilter, faFolder, faFolderOpen,
    faFolderTree, faGlobe, faHashtag, faHistory, faHome, faICursor, faImage,
    faImages, faInbox, faInfoCircle, faLink, faList, faMinus, faMinusSquare,
    faMoon, faMusic, faPager, faPaperPlane, faPaste, faPlus, faQuestionCircle,
    faQuoteRight, faRedo, faRobot, faSave, faSearch, faServer, faShareAlt,
    faShield, faShieldAlt, faSignOutAlt, faSortAlphaUp, faSortAmountDown,
    faSpinner, faSquare, faSun, faSync, faSyncAlt, faTachometerAlt, faTag,
    faTags, faThLarge, faTimes, faTools, faTrashAlt, faUpload, faUserCog,
    faUserPlus
...
const presetSiteTitle = (userConfig) => {
    document.title = userConfig?.siteTitle || 'FuHeng';
};
