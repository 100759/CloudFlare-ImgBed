<template>
    ...
    <div class="upload-home">
        ...
        <div class="header">
            <h1 class="title"><a class="main-title" href="https://fuheng.vip" target="_blank">{{ ownerName }}</a> ImgHub</h1>
        </div>
        <UploadForm 
...
export default {
    ...
    computed: {
        ...
        ownerName() {
            return this.userConfig?.ownerName || 'FuHeng'
        },
        dialogWidth() {
    ...
    methods: {
        ...
        handleMobileMenuCommand(command) {
            if (command === 'toggleTheme') {
                ...
                window.open('https://fuheng.vip', '_blank')
