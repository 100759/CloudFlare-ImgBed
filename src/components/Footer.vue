<template>
    <div class="page-footer" v-if="!disableFooter">
            <p>© 2024-{{ thisYear }} Designed by <a class="footer-name" href="https://fuheng.vip" target="_blank">FuHeng</a> for You!
...
export default {
    ...
    computed: {
        ...
        footerLink() {
            return this.userConfig?.footerLink || 'https://fuheng.vip'
        },
        thisYear() {
